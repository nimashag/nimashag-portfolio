...
const skillsData = {
  "Programming Languages": [
    ...
    { name: "Ballerina", level: 80, icon: BallerinaIcon, color: "#20b6b0" },
  ...
  "Soft Skills": [
    ...
    { name: "Time Management", level: 97, icon: Clock, color: "#10b981" },
    {
    ...
    { name: "Fast-learner", level: 95, icon: Zap, color: "#ef4444" },
    {
      name: "Communication",
      level: 95,
      icon: MessageCircle,
